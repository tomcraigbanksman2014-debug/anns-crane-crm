...
export async function POST(req: Request) {
  try {
    ...
    const payload: Record<string, any> = {
      ...
      movement_reference: abnormalLoadEnabled ? clean(body.movement_reference) : null,
      tractor_unit_registration: abnormalLoadEnabled ? clean(body.tractor_unit_registration) : null,
      tractor_unit_fleet_id: abnormalLoadEnabled ? clean(body.tractor_unit_fleet_id) : null,
      trailer_registration: abnormalLoadEnabled ? clean(body.trailer_registration) : null,
      trailer_fleet_id: abnormalLoadEnabled ? clean(body.trailer_fleet_id) : null,
      haulier_contact_name: abnormalLoadEnabled ? clean(body.haulier_contact_name) : null,
      haulier_contact_phone: abnormalLoadEnabled ? clean(body.haulier_contact_phone) : null,
      axle_configuration: abnormalLoadEnabled ? clean(body.axle_configuration) : null,
      front_axle_t: abnormalLoadEnabled ? numberOrNull(body.front_axle_t) : null,
      drive_axle_t: abnormalLoadEnabled ? numberOrNull(body.drive_axle_t) : null,
      trailer_axle_1_t: abnormalLoadEnabled ? numberOrNull(body.trailer_axle_1_t) : null,
      trailer_axle_2_t: abnormalLoadEnabled ? numberOrNull(body.trailer_axle_2_t) : null,
      trailer_axle_3_t: abnormalLoadEnabled ? numberOrNull(body.trailer_axle_3_t) : null,
      trailer_axle_4_t: abnormalLoadEnabled ? numberOrNull(body.trailer_axle_4_t) : null,
      route_start: abnormalLoadEnabled ? clean(body.route_start) : null,
      route_finish: abnormalLoadEnabled ? clean(body.route_finish) : null,
      planned_route: abnormalLoadEnabled ? clean(body.planned_route) : null,
      access_notes: abnormalLoadEnabled ? clean(body.access_notes) : null,
      authority_areas: abnormalLoadEnabled ? clean(body.authority_areas) : null,
      route_checked: abnormalLoadEnabled ? checkboxValue(body.route_checked) : false,
      escort_provider: abnormalLoadEnabled ? clean(body.escort_provider) : null,
      escort_contact_name: abnormalLoadEnabled ? clean(body.escort_contact_name) : null,
      escort_contact_phone: abnormalLoadEnabled ? clean(body.escort_contact_phone) : null,
      special_instructions: abnormalLoadEnabled ? clean(body.special_instructions) : null,
      contingency_notes: abnormalLoadEnabled ? clean(body.contingency_notes) : null,
      submission_method: abnormalLoadEnabled ? clean(body.submission_method) || "esdal" : null,
      submission_notes: abnormalLoadEnabled ? clean(body.submission_notes) : null,
      approval_reference: abnormalLoadEnabled ? clean(body.approval_reference) : null,
      approval_received_at: abnormalLoadEnabled ? dateTimeOrNull(body.approval_received_at) : null,
      authorised_to_move: abnormalLoadEnabled ? checkboxValue(body.authorised_to_move) : false,
      authorised_move_notes: abnormalLoadEnabled ? clean(body.authorised_move_notes) : null,
      police_reference: abnormalLoadEnabled ? clean(body.police_reference) : null,
      highways_reference: abnormalLoadEnabled ? clean(body.highways_reference) : null,
      bridge_reference: abnormalLoadEnabled ? clean(body.bridge_reference) : null,
      council_reference: abnormalLoadEnabled ? clean(body.council_reference) : null,
      special_order_reference: abnormalLoadEnabled ? clean(body.special_order_reference) : null,
      vr1_reference: abnormalLoadEnabled ? clean(body.vr1_reference) : null,
      checklist_vehicle_confirmed: abnormalLoadEnabled ? checkboxValue(body.checklist_vehicle_confirmed) : false,
      checklist_axle_data_confirmed: abnormalLoadEnabled ? checkboxValue(body.checklist_axle_data_confirmed) : false,
      checklist_contacts_confirmed: abnormalLoadEnabled ? checkboxValue(body.checklist_contacts_confirmed) : false,
      checklist_authorities_identified: abnormalLoadEnabled ? checkboxValue(body.checklist_authorities_identified) : false,
      checklist_documents_uploaded: abnormalLoadEnabled ? checkboxValue(body.checklist_documents_uploaded) : false,
      checklist_submission_reviewed: abnormalLoadEnabled ? checkboxValue(body.checklist_submission_reviewed) : false,
