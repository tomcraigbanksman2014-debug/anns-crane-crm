...
export default async function SocialStudioPage({
  ...
  const providerLabel = shouldUseAI
    ...
    <ClientShell>
      <div style={{ width: "min(1380px, 96vw)", margin: "0 auto" }}>
        ...
        {shouldUseAI ? (
          <div style={generation.provider === "openai" ? successCard : errorCard}>
            ...
            <div style={{ marginTop: 6, fontSize: 13, opacity: 0.8 }}>
              Provider: {generation.provider === "openai" ? "OpenAI" : "Fallback generator"}
            </div>
          </div>
        ) : (
          <div style={infoCard}>
            <div style={{ fontWeight: 900 }}>Preview mode</div>
            <div style={{ marginTop: 6, fontSize: 13, opacity: 0.8 }}>
              These posts are preview-only until you click Generate posts.
            </div>
          </div>
        )}
        ...
        <div style={statsGrid}>
          ...
          <StatCard label="Generation mode" value={providerLabel} />
              ...
              <div key={variant.key} style={postCard}>
                <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap" as const }}>
                  ...
                  <div style={{ display: "flex", gap: 8, flexWrap: "wrap" as const, alignItems: "center" }}>
                    ...
                    <div style={providerLabel === "AI" ? aiBadge : providerLabel === "Fallback" ? fallbackBadge : previewBadge}>
                      {providerLabel === "AI"
                        ? "Generated by AI"
                  ...
                  {canManage ? (
                    <form action={saveGeneratedTemplate} style={inlineForm}>
                      ...
                      <input
                        type="hidden"
                        name="description"
                        value={`Saved from Social Content Studio (${variant.title}) - ${providerLabel}.`}
                      />
...
const fallbackBadge: CSSProperties = {
  padding: "6px 8px",
  borderRadius: 999,
