...
export default function PublicOnboardingForm({
  ...
  return (
    <div className="form-wrap">
      ...
      <Section title="Business and tax details">
        <div className="grid three">
          <SelectField
            label="Business type *"
            ...
            options={[
              ...
              ["paye_worker", "PAYE worker"],
              ["other", "Other"],
            ]}
          />
          <Field label="Company registration number" value={data.company_registration_number} onChange={(v) => updateField("company_registration_number", v)} />
          <Field label="UTR number" value={data.utr_number} onChange={(v) => updateField("utr_number", v)} />
          <Field label="VAT number" value={data.vat_number} onChange={(v) => updateField("vat_number", v)} />
          <SelectField
