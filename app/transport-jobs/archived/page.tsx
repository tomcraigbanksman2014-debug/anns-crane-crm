...
import RestoreTransportJobButton from "../[id]/RestoreTransportJobButton";
...
export default async function ArchivedTransportJobsPage() {
    ...
    <ClientShell>
      <div style={{ width: "min(1450px, 96vw)", margin: "0 auto" }}>
        <div style={pageCard}>
          <div style={headerRow}>
            <div>
              <h1 style={{ margin: 0, fontSize: 32 }}>Archived Transport Jobs</h1>
              <p style={{ marginTop: 6, opacity: 0.8 }}>
                Restore archived transport jobs back into the live transport list.
              </p>
            </div>

            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              <a href="/transport-jobs" style={secondaryBtn}>
                Open active transport jobs
              </a>
            </div>
          </div>
          ...
          {error ? (
            ...
            <div style={emptyBox}>No archived transport jobs found.</div>
          ) : (
                      ...
                      <tr key={item.id}>
                        ...
                        <td style={tdStyle}>
                          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                            ...
                            <RestoreTransportJobButton jobId={item.id} />
                          </div>
                        </td>
                      </tr>
                    );
