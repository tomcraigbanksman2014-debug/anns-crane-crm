            ...
            <form action={updateJob} style={{ marginTop: 18, display: "grid", gap: 18 }}>
              ...
              <section style={sectionCard}>
                ...
                <div style={gridStyle}>
                  ...
                  <Field
                    label="Primary supplier cost"
                    value={moneyString(liveCostSubtotal)}
                    disabled
                  />
                </div>

                <div style={{ marginTop: 8, fontSize: 12, opacity: 0.75 }}>
                  Supplier cost is now driven from equipment and allocation costs, not a direct jobs table field.
                </div>
              </section>
