...
import RestoreJobButton from "../[id]/RestoreJobButton";
    ...
    <ClientShell>
      <div style={{ width: "min(1400px, 96vw)", margin: "0 auto" }}>
        <div style={pageCard}>
          <div style={headerRow}>
            <div>
              <h1 style={{ margin: 0, fontSize: 32 }}>Archived Jobs</h1>
              <p style={{ marginTop: 6, opacity: 0.8 }}>
                Restore archived crane jobs back into the live jobs list.
              </p>
            </div>
          ...
          {error ? (
            ...
            <div style={emptyBox}>No archived jobs found.</div>
          ) : (
